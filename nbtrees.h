...
/* Traversal PreOrder */
/* IS : P terdefinisi */
/* FS : Semua simpul P sudah ditampilkan secara PreOrder : parents ,
fs, nb */
void InOrder (Isi_Tree P);
/* Traversal InOrder */
/* IS : P terdefinisi */
/* FS : Semua simpul P sudah ditampilkan secara InOrder : fs, parents ,
Sisa anak lain */
...
/* Mengirimkan nullai terbesar dari dua data */
#endif
